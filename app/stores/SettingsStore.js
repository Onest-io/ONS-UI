...
const CORE_ASSET = "ONS"; // Setting this to BTS to prevent loading issues when used with BTS chain which is the most usual case currently
...
class SettingsStore {
    ...
    init() {
        return new Promise(resolve => {
            ...
            let coreAssets = {
                markets_4018d784: "ONS",
                markets_39f5e2ed: "TEST"
            };
            let coreAsset = coreAssets[this.starredKey] || "ONS";
            /*
    ...
    _getChainId() {
        return (Apis.instance().chain_id || "f8d9da89").substr(0, 8);
    }
